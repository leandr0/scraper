...
params = (
    ('types', ['COMMENTS_VISIBILITY', 'TRACK_LIKE_FOR_PERSONALIZATION', 'SHARING_POST_VISIBILITY_FOR_PERSONALIZATION', 'POST_VISBILE_ON_GROUP', 'EASY_APPLY_PHONE_NUMBER', 'RESUME_UPLOAD', 'MESSAGE_CONTROL', 'SMART_REPLIES', 'MANAGE_CONTACT_PAGE', 'MY_NETWORK_PAGE', 'REGISTRATION_FLOW_PROFILE_VISIBILITY', 'EDIT_FEED_ACTIVITY', 'SAVE_SEARCH_FOR_PERSONALIZATION', 'FIELDS_VISIBLE_ON_PROFILE', 'PUBLIC_VISIBILITY_ON_PROFILE', 'LOCATION_VISIBLE_ON_PROFILE', 'CONTROL_PROFILE_PHOTO', 'KEEPING_ORIGINAL_PHOTO_ON_PROFILE', 'CONTROL_DOWNLOADABLE_PROFILE_SECTIONS', 'CONTACT_INFO_VISIBILITY', 'CONTROL_PROFILE_VISIBILITY']),
)

response = requests.get('https://www.linkedin.com/psettings/policy/notices', headers=headers, params=params, cookies=cookies)
