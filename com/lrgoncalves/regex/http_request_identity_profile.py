...
headers = {
    ...
    'x-li-page-instance': 'urn:li:page:d_flagship3_profile_view_base;jXHPDGQUTLiBEeJ4beuSfA==',
...
response = requests.get('https://www.linkedin.com/voyager/api/identity/profiles/vera-cristina-de-f-vaz-68061866/profileActions', headers=headers, cookies=cookies)
